...
$ns node-config -phyType Phy/WirelessPhy$ns node-config -channelType Channel/WirelessChannel
...
$ns at 0.0 "$n1 setdest 250.0 100.0 20.0"
$ns at 0.0 "$n2 setdest 175.0 180.0 5.0"
